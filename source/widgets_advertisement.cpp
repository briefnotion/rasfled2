      ...
      ImGui::Begin(ADVERT_IMAGES[ADVERT_POS].FILENAME.c_str(), nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar);
      {
        ...
        // SCAN
        {
...

          {
            ...
            draw_list_advertisement->AddLine(line_start_1, line_end_1, sdSysData.PANEL_CONTROL.COLOR_SELECT.color(RAS_BLACK).STANDARD, 1.0f);
          }
          ...
          if (sdSysData.AIRCRAFT_COORD.is_active())
          {
            ...
            draw_list_advertisement->AddLine(line_start_1, line_end_1, sdSysData.PANEL_CONTROL.COLOR_SELECT.color(RAS_WHITE).STANDARD, 2.0f);
            draw_list_advertisement->AddLine(line_start_2, line_end_2, sdSysData.PANEL_CONTROL.COLOR_SELECT.color(RAS_RED).STANDARD, 2.0f);
          }

          ImGui::PushStyleColor(ImGuiCol_Text, ImU32(sdSysData.PANEL_CONTROL.COLOR_SELECT.color(RAS_BLACK).STANDARD));
