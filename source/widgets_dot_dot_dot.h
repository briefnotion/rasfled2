...
class DOT_DOT_DOT_SCREEN
{
  ...
  BUTTON_TOGGLE_COLOR ALTERNATIVE_TRACK;
  BUTTON_COLOR AUTO_TO_CONSOLE;
  BUTTON_COLOR GPS_TO_CONSOLE;

  BUTTON_TOGGLE_COLOR BRIGHTNESS_00;
  BUTTON_TOGGLE_COLOR BRIGHTNESS_10;
  BUTTON_TOGGLE_COLOR BRIGHTNESS_20;
  BUTTON_TOGGLE_COLOR BRIGHTNESS_30;
  BUTTON_TOGGLE_COLOR BRIGHTNESS_40;
  BUTTON_TOGGLE_COLOR BRIGHTNESS_50;
  BUTTON_TOGGLE_COLOR BRIGHTNESS_60;
  BUTTON_TOGGLE_COLOR BRIGHTNESS_70;
  BUTTON_TOGGLE_COLOR BRIGHTNESS_80;
  BUTTON_TOGGLE_COLOR BRIGHTNESS_90;
  BUTTON_TOGGLE_COLOR BRIGHTNESS_100;
  BUTTON_TOGGLE_COLOR BRIGHTNESS_AUTO;

  BUTTON_TOGGLE_COLOR TRACK_ASSIST;
