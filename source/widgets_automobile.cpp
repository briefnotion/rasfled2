              ...
              ImVec2 Start_Pos, bool Value, bool Ping, bool Details)
{
  if (Details)
  {
    if (Ping)
    {
      if (Value)
      {
        Draw_List->AddRectFilled(Start_Pos, ImVec2(Start_Pos.x + 4.0f, Start_Pos.y + 15.0f), sdSysData.COLOR_SELECT.neo_color_STANDARD_V(RAS_WHITE));
      }
      else
      {
        Draw_List->AddRect(Start_Pos, ImVec2(Start_Pos.x + 4.0f, Start_Pos.y + 7.0f), sdSysData.COLOR_SELECT.neo_color_STANDARD_V(RAS_WHITE));
      }
    }
    else
    {
      if (Value)
      {
        Draw_List->AddRectFilled(Start_Pos, ImVec2(Start_Pos.x + 4.0f, Start_Pos.y + 15.0f), sdSysData.COLOR_SELECT.neo_color_STANDARD(RAS_GREEN));
      }
      else
      {
        Draw_List->AddRect(Start_Pos, ImVec2(Start_Pos.x + 4.0f, Start_Pos.y + 7.0f), sdSysData.COLOR_SELECT.neo_color_STANDARD(RAS_GREEN));
      }
    }
  }
  else
    ...
    if (Ping)
    {
      if (Value)
      {
        Draw_List->AddLine(Start_Pos, ImVec2(Start_Pos.x + 6.0f, Start_Pos.y), 
                            sdSysData.COLOR_SELECT.neo_color_STANDARD_V(RAS_WHITE), 5.0f);
      }
      else
      {
        Draw_List->AddLine(Start_Pos, ImVec2(Start_Pos.x + 6.0f, Start_Pos.y), 
                            sdSysData.COLOR_SELECT.neo_color_STANDARD_V(RAS_WHITE), 1.0f);
      }
    }
    else
    {
      ...
      {
        Draw_List->AddLine(Start_Pos, ImVec2(Start_Pos.x + 6.0f, Start_Pos.y), 
                            sdSysData.COLOR_SELECT.neo_color_STANDARD(RAS_GREEN), 5.0f);
      }
      else
      {
        Draw_List->AddLine(Start_Pos, ImVec2(Start_Pos.x + 6.0f, Start_Pos.y), 
                            sdSysData.COLOR_SELECT.neo_color_STANDARD(RAS_GREEN), 1.0f);
      }
    }
  }
}
  ...
  for (int bit = 0; bit < 64; bit++)
  {
    ...
    if (bit % 8 == 0)
    {
      Draw_List->AddLine(ImVec2(current_position.x + 38.0f + (9.5f * (float)bit), current_position.y + 1.0f), 
                          ...
                          sdSysData.COLOR_SELECT.neo_color_STANDARD_V(RAS_WHITE), 2.0f);
    }
  }
...
bool T_LARGE_NUMBER_DISPLAY::draw(system_data &sdSysData, bool Draw, float Y_Height)
{
        ...
        FRAME_START_POS.y != start_position.y)
  {
    ...
    if (PROPS.VERY_LARGE)
    {
      DISPLAY_SIZE = ImVec2(120.0f * DEF_SCREEN_SIZE_X_MULTIPLIER, Y_Height);
    }
    else
    {
      DISPLAY_SIZE = ImVec2(83.0f * DEF_SCREEN_SIZE_X_MULTIPLIER, Y_Height);
    }
  ...
  if (Draw)
  {
    ...
    else if (abs(VALUE) < 100)  // Continue drawing rotating numbers if value is < 100
    {
      if (ACTIVE_WITHIN == true)
      {
        ...
        {
          ImGui::PushStyleColor(ImGuiCol_Text, ImU32(sdSysData.COLOR_SELECT.neo_color_TEXT(RAS_YELLOW)));
        }
      ...
      // Positive Values
      {
        ...
        {
          ImGui::PushStyleColor(ImGuiCol_Text, ImU32(sdSysData.COLOR_SELECT.neo_color_TEXT(PROPS.COLOR_SCALE.get_color(VALUE))));
        }
        else
        {
          ImGui::PushStyleColor(ImGuiCol_Text, ImU32(WHEEL_COLOR.boolean_color(sdSysData, (VALUE >= 0.0f), 
                                sdSysData.COLOR_SELECT.neo_color_TEXT(RAS_WHITE), 
                                sdSysData.COLOR_SELECT.neo_color_TEXT(RAS_YELLOW))));
        }
  ...
  {
    {
      ...
      SDATA.VB_SPEED.PROPS.BAR_HEIGHT = 30 / 4 * DEF_SCREEN_SIZE_X_MULTIPLIER;
      SDATA.VB_SPEED.PROPS.MARKER_SIZE = 15 * DEF_SCREEN_SIZE_X_MULTIPLIER;
    ...
    }
    {
      ...
      SDATA.VB_S_TEMP.PROPS.BAR_HEIGHT = 30 / 4 * DEF_SCREEN_SIZE_X_MULTIPLIER;
      SDATA.VB_S_TEMP.PROPS.MARKER_SIZE = 15 * DEF_SCREEN_SIZE_X_MULTIPLIER;
    ...
    }
    {
      ...
      SDATA.VB_S_FUEL.PROPS.BAR_HEIGHT = 30 / 4 * DEF_SCREEN_SIZE_X_MULTIPLIER;
      SDATA.VB_S_FUEL.PROPS.MARKER_SIZE = 15 * DEF_SCREEN_SIZE_X_MULTIPLIER;
    ...
    }
    {
      ...
      SDATA.VB_S_VOLTAGE.PROPS.BAR_HEIGHT = 30 / 4 * DEF_SCREEN_SIZE_X_MULTIPLIER;
      SDATA.VB_S_VOLTAGE.PROPS.MARKER_SIZE = 15 * DEF_SCREEN_SIZE_X_MULTIPLIER;
  ...
  {
    {
      ...
      SDATA.TB_STEERING.PROPS.BAR_HEIGHT = 5 * DEF_SCREEN_SIZE_X_MULTIPLIER;
      SDATA.TB_STEERING.PROPS.MARKER_SIZE = 20 * DEF_SCREEN_SIZE_X_MULTIPLIER;
    ...
    }
    {
      ...
      SDATA.TB_SPEED.PROPS.BAR_HEIGHT = 20 * DEF_SCREEN_SIZE_X_MULTIPLIER;
      SDATA.TB_SPEED.PROPS.MARKER_SIZE = 20 * DEF_SCREEN_SIZE_X_MULTIPLIER;
    ...
    }
    {
      ...
      SDATA.TB_ACCELERATION.PROPS.BAR_HEIGHT = 20 * DEF_SCREEN_SIZE_X_MULTIPLIER;
      SDATA.TB_ACCELERATION.PROPS.MARKER_SIZE = 20 * DEF_SCREEN_SIZE_X_MULTIPLIER;
    ...
    }
    {
      ...
      SDATA.TB_RPM.PROPS.BAR_HEIGHT = 20 * DEF_SCREEN_SIZE_X_MULTIPLIER;
      SDATA.TB_RPM.PROPS.MARKER_SIZE = 20 * DEF_SCREEN_SIZE_X_MULTIPLIER;
    ...
    }
    {
      ...
      SDATA.TB_TORQUE.PROPS.BAR_HEIGHT = 20 * DEF_SCREEN_SIZE_X_MULTIPLIER;
    ...
    }
    {
      ...
      SDATA.VB_DECELERATOR.PROPS.BAR_HEIGHT = 20 * DEF_SCREEN_SIZE_X_MULTIPLIER;
      SDATA.VB_DECELERATOR.PROPS.MARKER_SIZE = 5 * DEF_SCREEN_SIZE_X_MULTIPLIER;
    ...
    }
    {
      ...
      SDATA.VB_BRAKE.PROPS.BAR_HEIGHT = 20 * DEF_SCREEN_SIZE_X_MULTIPLIER;
      SDATA.VB_BRAKE.PROPS.MARKER_SIZE = 5 * DEF_SCREEN_SIZE_X_MULTIPLIER;
    ...
    }
    {
      ...
      SDATA.VB_ACCELERATOR.PROPS.BAR_HEIGHT = 20 * DEF_SCREEN_SIZE_X_MULTIPLIER;
      SDATA.VB_ACCELERATOR.PROPS.MARKER_SIZE = 5 * DEF_SCREEN_SIZE_X_MULTIPLIER;
    ...
    {
      {
        ...
        SDATA.VB_TEMPERATURE_COOLANT.PROPS.BAR_HEIGHT = 30.0f / 5.0f * DEF_SCREEN_SIZE_X_MULTIPLIER;
      ...
      }
      {
        ...
        SDATA.VB_TEMPERATURE_INTAKE.PROPS.BAR_HEIGHT = 30.0f / 5.0f * DEF_SCREEN_SIZE_X_MULTIPLIER;
      ...
      }
      {
        ...
        SDATA.VB_TEMPERATURE_AMBIANT.PROPS.BAR_HEIGHT = 30.0f / 5.0f * DEF_SCREEN_SIZE_X_MULTIPLIER;
      ...
      }
      {
        ...
        SDATA.VB_TEMPERATURE_CATALYST.PROPS.BAR_HEIGHT = 30.0f / 5.0f * DEF_SCREEN_SIZE_X_MULTIPLIER;
      ...
      }
      {
        ...
        SDATA.VB_TEMPERATURE_S_TEMP.PROPS.BAR_HEIGHT = 30.0f / 5.0f * DEF_SCREEN_SIZE_X_MULTIPLIER;
    ...
    {
      {
        ...
        SDATA.VB_POWER_TACH.PROPS.BAR_HEIGHT = 30.0f / 5.0f * DEF_SCREEN_SIZE_X_MULTIPLIER;
      ...
      }
      {
        ...
        SDATA.VB_POWER_TORQE.PROPS.BAR_HEIGHT = 30.0f / 5.0f * DEF_SCREEN_SIZE_X_MULTIPLIER;
      ...
      }
      {
        ...
        SDATA.VB_POWER_ACCELERATION.PROPS.BAR_HEIGHT = 30.0f / 5.0f * DEF_SCREEN_SIZE_X_MULTIPLIER;
      ...
      }
      {
        ...
        SDATA.VB_POWER_FUEL_RAIL_P.PROPS.BAR_HEIGHT = 30.0f / 5.0f * DEF_SCREEN_SIZE_X_MULTIPLIER;
      ...
      }
      {
        ...
        SDATA.VB_POWER_SYSTEM_VAPER_P.PROPS.BAR_HEIGHT = 30.0f / 5.0f * DEF_SCREEN_SIZE_X_MULTIPLIER;
