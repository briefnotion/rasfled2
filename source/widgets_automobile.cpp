...
void T_LARGE_NUMBER_DISPLAY::draw(system_data &sdSysData)
{
  ...
  if (PROPS.DISPLAY_MIN_MAX)
  {
    ...
    ImGui::PushStyleColor(ImGuiCol_Text, sdSysData.COLOR_SELECT.COLOR_COMB_GREY.TEXT);
...
void T_DATA_DISPLAY::draw(system_data &sdSysData)
{
  ...
  {
    ImGui::PushStyleColor(ImGuiCol_Text, PROPS.COLOR_SCALE.get_color(VALUE_FLOAT).TEXT);
    DATA.draw(sdSysData);
    ImGui::PopStyleColor();
  }
  else
