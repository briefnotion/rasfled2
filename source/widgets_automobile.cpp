...
void AUTOMOBILE_SCREEN::create(system_data &sdSysData)
{
  ...
  */
  ...
  SDATA.D_TEMP_COOLANT.PROPS.COLOR_SCALE.add_color_value_pair(60.0f, sdSysData.COLOR_SELECT.COLOR_COMB_BLUE);
...
void AUTOMOBILE_SCREEN::update(system_data &sdSysData)
{
  ...
  */
  ...
  SDATA.L_TACH_SB.update_value(sdSysData, SDATA.RPM / 100);
