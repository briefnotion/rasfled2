...
class AUTOMOBILE_SCREEN
{
  ...
  BUTTON_TOGGLE_COLOR BTC_NOVA_2_GPS; // NOVA_2_SELECTION = 5;
  BUTTON_TOGGLE_COLOR BTC_NOVA_2_COMPASS; // NOVA_2_SELECTION = 5;
  ...
  T_DATA_DISPLAY NOVA_2_STEERING_WHEEL_ANGLE_ADJUSTED;
  ...
  // GPS OTHER
  T_DATA_DISPLAY NOVA_2_GPS_ACTIVE;
  T_DATA_DISPLAY NOVA_2_GPS_CURRENT_LOCATION_LATITUDE;
  T_DATA_DISPLAY NOVA_2_GPS_CURRENT_LOCATION_LONGITUDE;
  T_DATA_DISPLAY NOVA_2_GPS_CURRENT_ALTITUDE;
  T_DATA_DISPLAY NOVA_2_GPS_CURRENT_HEADING;
  T_DATA_DISPLAY NOVA_2_GPS_SPEED;
  T_DATA_DISPLAY NOVA_2_GPS_PHV;
  T_DATA_DISPLAY NOVA_2_GPS_SATILITES;
  T_DATA_DISPLAY NOVA_2_GPS_NMEA_TIMESTAMP;
  T_DATA_DISPLAY NOVA_2_GPS_SYSTEM_TIMESTAMP;
  T_DATA_DISPLAY NOVA_2_TIMESTAMP_DIFFERENCE;

  // COMPASS 
  T_DATA_DISPLAY NOVA_2_COMPASS_INFORMATION;
  T_DATA_DISPLAY NOVA_2_COMPASS_INFORMATION_CALIBRATION;

  T_DATA_DISPLAY NOVA_2_GLOBE_HELPER_BRIGHTNESS_FACTOR;
