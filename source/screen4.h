...
class SCREEN4
{
  ...
  BUTTON_TOGGLE_COLOR BTC_TAB_CAMERA;
  ...
  BUTTON_TOGGLE_COLOR BTC_CAMERA_START_STOP;
  ...
  BUTTON_TOGGLE_COLOR BTC_AUTONOMOUS;
  ...
  vector<ALERT_WIDGET> ADSB_ALERTS;
  ...
  // Black Color for Blinkers and Indicators
  ImColor BLACK_QPAQUE;

  // Door Indicators
  NEO_COLOR DOOR_INDICATOR_RD;
  NEO_COLOR DOOR_INDICATOR_FD;
  NEO_COLOR DOOR_INDICATOR_RP;
  NEO_COLOR DOOR_INDICATOR_FP;
