...
// reserve alerts
void ALERT_SYSTEM_2::res_alert_no_condition(COMMAND_THREAD &Thread, int Id, string Alert_Text)
{
  ALERTS_RESERVE[Id].alert_no_condition(Id, Alert_Text);
  SOUND_SYSTEM.play_c6(Thread, MUTE);
}

bool ALERT_SYSTEM_2::res_alert_condition(COMMAND_THREAD &Thread, int Id, bool Raise_Alert, bool Clear_Alert)
{
  int alert_change = 0;
  ...
  {
    SOUND_SYSTEM.play_alert_level_3(Thread, MUTE);
  }
  else if (alert_change  == 1)  // Warning
  {
    SOUND_SYSTEM.play_alert_level_2(Thread, MUTE);
  }
  else if (alert_change  == -1)  // Cleared
  {
    SOUND_SYSTEM.play_alert_level_1(Thread, MUTE);
  }
...
void ALERT_SYSTEM_2::add_generic_alert(COMMAND_THREAD &Thread, string Text)
{
  ...
  SOUND_SYSTEM.play_a6(Thread, MUTE);
...
void ALERT_SYSTEM_2::sound_alert(COMMAND_THREAD &Thread, int Value)
{
  if (Value == 3)
  {
    SOUND_SYSTEM.play_alert_level_3(Thread, MUTE);
...
void ALERT_SYSTEM_2::sound_tone(COMMAND_THREAD &Thread, int Value)
{
  if (Value == 61)
  {
    SOUND_SYSTEM.play_c6(Thread, MUTE);
  ...
  {
    SOUND_SYSTEM.play_d6(Thread, MUTE);
  }
  else if (Value == 63)
  {
    SOUND_SYSTEM.play_e6(Thread, MUTE);
  }
  else if (Value == 64)
  {
    SOUND_SYSTEM.play_f6(Thread, MUTE);
  }
  else if (Value == 65)
  {
    SOUND_SYSTEM.play_g6(Thread, MUTE);
  }
  else if (Value == 66)
  {
    SOUND_SYSTEM.play_a6(Thread, MUTE);
  ...
  {
    SOUND_SYSTEM.play_b6(Thread, MUTE);
  }
  else // invalid
  {
    SOUND_SYSTEM.play_alert_level_1(Thread, MUTE);
